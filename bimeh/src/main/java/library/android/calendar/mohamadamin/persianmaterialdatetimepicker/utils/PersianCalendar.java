 ...
 * @version 1.1
 */
//public class PersianCalendar extends GregorianCalendar implements Serializable{
...
//		super();
	...
	public void init2(){
		calendarTool = new CalendarTool(get(YEAR),get(MONTH), get(DAY_OF_MONTH));
	}
...
//			calendarTool = new CalendarTool(get(YEAR),get(MONTH), get(DAY_OF_MONTH));
//		else
//			calendarTool.setGregorianDate(get(YEAR),get(MONTH), get(DAY_OF_MONTH));
		...
		this.persianDay = day;
////		calendarTool.setGregorianDate(get(YEAR),get(MONTH), get(DAY_OF_MONTH));
//		this.persianYear = calendarTool.getIranianYear();
//		this.persianMonth = calendarTool.getIranianMonth();
//		this.persianDay = calendarTool.getIranianDay();
	}
...
////		CalendarTool calendarTool = new CalendarTool(get(YEAR),get(MONTH), get(DAY_OF_MONTH));
//		calendarTool.setIranianDate(persianYear, persianMonth, persianDay);
//		this.persianYear = calendarTool.getIranianYear();
//		this.persianMonth = calendarTool.getIranianMonth();
//		this.persianDay = calendarTool.getIranianDay();
//		set(YEAR, calendarTool.getGregorianYear());
//		set(MONTH, calendarTool.getGregorianMonth());
//		set(DAY_OF_MONTH, calendarTool.getGregorianDay());
		set(YEAR, persianYear);
		set(MONTH, persianMonth);
		set(DAY_OF_MONTH, persianDay);
		//persianMonth += 1;
...
//		return PersianCalendarConstants.persianMonthNames[this.persianMonth];
		return PersianCalendarConstants.persianMonthNames[get(MONTH)];
	}
...
//		return "" + formatToMilitary(this.persianYear) + delimiter + formatToMilitary(getPersianMonth()+1) + delimiter + formatToMilitary(this.persianDay);
		return "" + formatToMilitary(getPersianYear()) + delimiter + formatToMilitary(getPersianMonth()) + delimiter + formatToMilitary(getPersianDay());
	}
...
//				+ ":" + formatToMilitary(get(SECOND));
		return "" + formatToMilitary(getPersianYear()) + delimiter + formatToMilitary(getPersianMonth()) + delimiter + formatToMilitary(getPersianDay()) + " " + formatToMilitary(this.get(HOUR_OF_DAY)) + ":" + formatToMilitary(get(MINUTE))
				+ ":" + formatToMilitary(get(SECOND));
	}
...
//		calculatePersianDate();
	...
	public Calendar toGregorianCalendar(){
		YearMonthDate yearMonthDate = JalaliCalendar.jalaliToGregorian(new YearMonthDate(get(YEAR), get(MONTH), get(DATE)));
		Calendar instance = Calendar.getInstance();
		instance.setTimeInMillis(getTimeInMillis());
		instance.set(YEAR, yearMonthDate.getYear());
		instance.set(MONTH, yearMonthDate.getMonth());
		instance.set(DATE, yearMonthDate.getDate());
		return instance;
	}
