...
package library.android.calendar.mohamadamin.persianmaterialdatetimepicker.time;
...
import library.android.calendar.mohamadamin.persianmaterialdatetimepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCancelButton.setTypeface(TypefaceHelper.get(getDialog().getContext(),"IRANSansMobile"));
        ...
        ColorStateList doneTextColor = res.getColorStateList(R.color.mdtp_done_text_color_normal);
//        int doneBackground = R.drawable.mdtp_done_background_color;
        ...
        ColorStateList darkDoneTextColor = res.getColorStateList(R.color.mdtp_done_text_color_dark_normal);
