...
import library.android.calendar.mohamadamin.persianmaterialdatetimepicker.date.MonthAdapter.CalendarDay;
...
//        mMonthTitlePaint.setTypeface(Typeface.create(mMonthTitleTypeface, Typeface.BOLD));
        mMonthTitlePaint.setTypeface(TypefaceHelper.get(getContext(), "IRANSansMobile_Bold"));
        ...
        mMonthDayLabelPaint.setTypeface(TypefaceHelper.get(getContext(), "IRANSansMobile_Bold"));
