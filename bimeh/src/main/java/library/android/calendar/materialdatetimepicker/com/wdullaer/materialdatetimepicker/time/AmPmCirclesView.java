...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, TimePickerController controller, int amOrPm) {
        ...
        if (controller.isThemeDark()) {
            ...
            mAmPmTextColor = ContextCompat.getColor(context, R.color.gmdtp_white);
            mAmPmDisabledTextColor = ContextCompat.getColor(context, R.color.mdtp_date_picker_text_disabled_dark_theme);
            mSelectedAlpha = SELECTED_ALPHA_THEME_DARK;
        } else {
            mUnselectedColor = ContextCompat.getColor(context, R.color.gmdtp_white);
        ...
        mAmPmSelectedTextColor = ContextCompat.getColor(context, R.color.gmdtp_white);
        ...
        mCircleRadiusMultiplier =
                Float.parseFloat(res.getString(R.string.gmdtp_circle_radius_multiplier));
