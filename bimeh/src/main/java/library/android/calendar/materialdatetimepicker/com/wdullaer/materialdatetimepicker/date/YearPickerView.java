...
public class YearPickerView extends ListView implements OnItemClickListener, DatePickerDialog.OnDateChangedListener {
    ...
    public YearPickerView(Context context, DatePickerController controller) {
        ...
        mViewSize = res.getDimensionPixelOffset(R.dimen.gmdtp_date_picker_view_animator_height);
        mChildSize = res.getDimensionPixelOffset(R.dimen.gmdtp_year_label_height);
