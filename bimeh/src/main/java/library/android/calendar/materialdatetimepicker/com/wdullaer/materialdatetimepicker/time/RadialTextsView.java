...
package library.android.calendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.time;
...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts,
        ...
        // Set up the paint.
        int textColorRes = controller.isThemeDark() ? R.color.gmdtp_white : R.color.mdtp_numbers_text_color;
        ...
        int selectedTextColor = ContextCompat.getColor(context, R.color.gmdtp_white);
        ...
        if (mIs24HourMode) {
            mCircleRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_circle_radius_multiplier_24HourMode));
        } else {
            mCircleRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_circle_radius_multiplier));
            mAmPmCircleRadiusMultiplier =
                    Float.parseFloat(res.getString(R.string.gmdtp_ampm_circle_radius_multiplier));
        }
        ...
        if (mHasInnerCircle) {
            mNumbersRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_numbers_radius_multiplier_outer));
            mTextSizeMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_text_size_multiplier_outer));
            mInnerNumbersRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_numbers_radius_multiplier_inner));
            mInnerTextSizeMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_text_size_multiplier_inner));

            mInnerTextGridHeights = new float[7];
            mInnerTextGridWidths = new float[7];
        } else {
            mNumbersRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_numbers_radius_multiplier_normal));
            mTextSizeMultiplier = Float.parseFloat(
                    res.getString(R.string.gmdtp_text_size_multiplier_normal));
        }
