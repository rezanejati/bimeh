...
import library.android.calendar.mohamadamin.persianmaterialdatetimepicker.utils.PersianCalendarUtils;
...
public class Utils {
    ...
    public static SpannableString getSpannableBold(Context context, String mi, int size) {
        ...
        mNewTitle.setSpan(new TypefaceSpan(context, "IRANSansMobile_Bold.ttf", size), 0, mNewTitle.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
        return mNewTitle;
    }
}
