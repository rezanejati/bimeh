...
/**
 * Created by Amir H on 11/5/2016.
 */
...
public class JalaliCalendar extends Calendar {
    ...
    public JalaliCalendar(long milis) {
        this(milis, TimeZone.getDefault(), Locale.getDefault());
    }
    ...
    public JalaliCalendar(long milis, TimeZone zone, Locale aLocale) {
