...
public abstract class MonthView extends View {
    ...
    protected int mEndSelectedDay = -1;
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        ...
        mSelectedDayTextColor = ContextCompat.getColor(context, R.color.gmdtp_white);
        ...
        MONTH_DAY_LABEL_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.gmdtp_month_day_label_text_size);
        MONTH_HEADER_SIZE = res.getDimensionPixelOffset(R.dimen.gmdtp_month_list_item_header_height);
        DAY_SELECTED_CIRCLE_SIZE = res
                .getDimensionPixelSize(R.dimen.gmdtp_day_number_select_circle_radius);

        mRowHeight = (res.getDimensionPixelOffset(R.dimen.gmdtp_date_picker_view_animator_height)
    ...
    protected void initView() {
        ...
        mRangeCirclePaint.setFakeBoldText(true);
        mRangeCirclePaint.setAntiAlias(true);
        mRangeCirclePaint.setColor(Color.parseColor("#dbd5b5"));
        mRangeCirclePaint.setTextAlign(Align.CENTER);
        mRangeCirclePaint.setStyle(Style.FILL);
        mRangeCirclePaint.setAlpha(SELECTED_CIRCLE_ALPHA);
     ...
     * {@link #VIEW_PARAMS_HEIGHT} for more info_f on parameters.
     *
    ...
    public void setMonthParams(HashMap<String, Integer> params) {
        ...
        if (params.containsKey(VIEW_PARAMS_END_SELECTED_DAY)) {
            mEndSelectedDay = params.get(VIEW_PARAMS_END_SELECTED_DAY);
        }
